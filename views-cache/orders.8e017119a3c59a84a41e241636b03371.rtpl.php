                ...
                <div class="box box-primary">
                    <div class="box-tools">
                        <div class="box-header" style="padding-top: 50px">
                            <div class="box-tools no-padding">
                                <form action="/admin/orders">
                                    <div class="input-group input-group-sm" style="width: 150px;">
                                        <input type="text" name="search" class="form-control pull-right"
                                               placeholder="ID do Pedido" value="<?php echo htmlspecialchars( $search, ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                            ...
                            <div class="box-body no-padding">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/admin/orders/<?php echo htmlspecialchars( $value1["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-default btn-xs"><i
                                                    class="fa fa-search"></i> Detalhes</a>
                                            <a href="/admin/orders/<?php echo htmlspecialchars( $value1["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/status"
                                               class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i> Status</a>
