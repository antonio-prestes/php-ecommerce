              ...
              <div class="box-tools">
                <form action="/admin/users">
                  <div class="input-group input-group-sm" style="width: 170px;">
                    <input type="text" name="search" class="form-control pull-right" placeholder="Nome, login ou e-mail" value="<?php echo htmlspecialchars( $search, ENT_COMPAT, 'UTF-8', FALSE ); ?>">
